        ...
        private void OnModeEnd(int modeID, int CurrentExitAbility)
        {
            if (PlayingCombo)
            {
                ...
                if (ActiveComboSequence.Finisher)
                {
                    ...
                    Debugging($"Combo Finished. <b>[{ActiveComboSequenceIndex}]</b> Branch:<b>[{Branch}]</b>. [Restarting]");
                    Restart();
                ...
                else if (CurrentExitAbility == ActiveComboSequence.Ability)
                {
                    ...
                    {
                        Debugging($"Incomplete <b>[{ActiveComboSequenceIndex}]</b> Branch: <b>[{Branch}]</b>. [Restarting*]");
