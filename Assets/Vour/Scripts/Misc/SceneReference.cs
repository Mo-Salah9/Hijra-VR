...
// Credit to Ryan Hipple (https://github.com/roboryantron/UnityEditorJunkie) & MyBox (https://github.com/Deadcows/MyBox)
	...
	public class SceneReference : ISerializationCallbackReceiver
	{
		...
		public void OnBeforeSerialize()
		{
			...
			if (Scene != null)
			{
				...
				var sceneInBuild = Editor.SceneReferenceUtils.GetSceneInBuildState(sceneAssetGUID);
...
namespace CrizGames.Vour.Editor
{
	...
	public class SceneReferenceEditor : PropertyDrawer
	{
		...
		private void DisplaySceneErrorPrompt(string message)
		{
			...
			GUIUtility.ExitGUI(); // Fix for InvalidOperationException; See https://discussions.unity.com/t/691628/
		}
